    ...
    <div class="mt-5 ms-auto  me-auto " style=" width: 500px;">
        <div class="loginSentre ">
            ...
            <div class="d-flex " style="align-items: baseline ;margin-left: 3em;">
                <h3 class="m-3"><a href="/login" style="display: contents">User</a></h3>
                <h4 class="m-2"><a href="/loginadmin" style="display: contents">Admin</a></h4>
            </div>
            ...
            <form action="/r" method="GET" style="display: flex;flex-direction: row-reverse;padding-right: 2em;">
